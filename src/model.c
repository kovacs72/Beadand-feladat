...
void init_entities(World* world) {
	// Object1
	load_model("models//objectfile.obj", &world->objektum1.model);
	world->objektum1.texture = load_texture("textures//objektum.png");
	init_object(&world->objektum1, 120, 170);

	// Object2
	load_model("models//objectfile.obj", &world->objektum2.model);
	world->objektum2.texture = load_texture("textures//objektum2.png");
	init_object(&world->objektum2, 0, 170);
	
	// Object3
	load_model("models//objectfile.obj", &world->objektum3.model);
	world->objektum3.texture = load_texture("textures//objektum3.jpg");
	init_object(&world->objektum3, -120, 170);
